...
export default function PropertiesPage() {
  return (
    <>
      <SEO
        title="Properties"
        description="Browse live property listings for sale and to rent across Cape Town — powered by Just Property."
        path="/properties"
      />
      ...
      <section className="bg-teal-800 py-14">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-3 text-[14px] text-gray-300 max-w-xl mx-auto">
            Browse verified listings powered by Just Property — updated in real time.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto mb-14">
            <a
              ...
              className="flex items-center justify-center gap-3 rounded-xl bg-teal-800 px-6 py-5 text-white hover:bg-teal-700 transition-colors group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 rounded-xl bg-gold-500 px-6 py-5 text-teal-900 hover:bg-gold-400 transition-colors group"
            >
              ...
              <div>
                ...
                <span className="block text-[12px] text-teal-700">Browse all Cape Town rentals</span>
              </div>
              <svg className="h-4 w-4 ml-auto opacity-50 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" /></svg>
            </a>
          </div>
          ...
          {/* By Suburb */}
          <h2 className="text-2xl font-semibold text-teal-800 mb-8 text-center">Browse by Suburb</h2>
                  ...
                  .map((suburb) => (
                    <div key={suburb.slug} className="flex flex-col gap-1.5">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="rounded-lg border border-gray-100 px-3 py-2 text-[13px] text-teal-700 hover:border-gold-300 hover:bg-gold-50 transition-all text-center"
                      >
                        {suburb.name}
      ...
      <section className="py-12 bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-semibold text-teal-800 mb-8 text-center">More Property Types</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              >
                <span className="text-[14px] font-medium text-teal-800 group-hover:text-gold-600 transition-colors">{item.label}</span>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl font-semibold text-teal-800 mb-3">Can't Find What You're Looking For?</h2>
