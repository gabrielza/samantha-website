            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <a
                  ...
                  className="flex items-center gap-5 rounded-2xl bg-navy-50 border border-navy-200 p-5 hover:shadow-md transition-all group"
                >
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-navy-800 text-white group-hover:scale-110 transition-transform">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-navy-800">Call Samantha</p>
