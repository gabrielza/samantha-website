        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-4 text-[13px] text-gray-400 leading-relaxed">
              Experienced Property Practitioner across the Atlantic Seaboard,
              City Bowl, and Northern Suburbs.
            </p>
            <div className="flex gap-3 mt-5">
              <a href={contact.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="h-9 w-9 rounded-lg bg-teal-700 flex items-center justify-center text-gray-400 hover:text-gold-400 hover:bg-teal-600 transition-all">
              ...
              <a href={contact.social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="h-9 w-9 rounded-lg bg-teal-700 flex items-center justify-center text-gray-400 hover:text-gold-400 hover:bg-teal-600 transition-all">
